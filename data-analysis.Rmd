...
```{r, tidy=TRUE, cache=TRUE}
#sum(unique(be2olak.data$rd.rp.cmid))
```
...
```{r, tidy=TRUE, cache=TRUE}
plot(be2olak.data$rd.rp.cm)
barplot(be2olak.data$rd.rp.stid, names.arg=be2olak.data$rd.rp.cm, horiz=TRUE, las=1, cex.names=1, border=NA)
```

```{r, tidy=TRUE, cache=TRUE}
boxplot(be2olak.data$rd.rp.stid)
barplot(be2olak.data$rd.rp.stid)
```

```{r, tidy=TRUE, cache=TRUE}
#comments <- be2olak.data$rd.rp.cm
#comments.freq <- table(comments)
#print(comments.freq)
```
