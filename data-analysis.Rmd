...
cor_feats = c("comment.time", "report.hr", "week.day","month.day", "rd.rp.stid", "rd.cmrq", "rd.strq", "rd.new")
...
ggplot(be2olak.data.filtered, aes(x=report.hr, y=rd.rp.stid, fill=report.hr)) + geom_jitter()
```
